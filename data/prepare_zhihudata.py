...
if not os.path.exists("zhihu_jinyong"):
    os.makedirs("zhihu_jinyong")

np.array(train_data, dtype=np.uint16).tofile(os.path.join("zhihu_jinyong", "train.bin"))
np.array(val_data, dtype=np.uint16).tofile(os.path.join("zhihu_jinyong", "val.bin"))
